...
for data_type in data_types:
    ...
    filename = f'E:/APhD/_Projects/3) Handwritting signature/Models/KNN/KNN_{data_type}_model.sav'
    ...
    cm_df.to_csv(f'E:/APhD/_Projects/3) Handwritting signature/Models/KNN/KNN_{data_type}_cm.csv', index=False)
